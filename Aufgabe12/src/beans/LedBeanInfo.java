 ...
 * @author le
 */
public class LedBeanInfo extends SimpleBeanInfo
{

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( beans.Led.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_eingeschaltet = 0;
    private static final int PROPERTY_farbe = 1;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_eingeschaltet] = new PropertyDescriptor ( "eingeschaltet", beans.Led.class, "isEingeschaltet", "setEingeschaltet" ); // NOI18N
            properties[PROPERTY_farbe] = new PropertyDescriptor ( "farbe", beans.Led.class, "getFarbe", "setFarbe" ); // NOI18N
        }
    ...
    private static final int EVENT_ledListener = 0;
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ledListener] = new EventSetDescriptor ( beans.Led.class, "ledListener", beans.LedListener.class, new String[] {"ledStateChanged"}, "addLedListener", "removeLedListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( beans.Led.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( beans.Led.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static final int METHOD_hinUndHerschalten0 = 0;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_hinUndHerschalten0] = new MethodDescriptor(beans.Led.class.getMethod("hinUndHerschalten", new Class[] {})); // NOI18N
            methods[METHOD_hinUndHerschalten0].setDisplayName ( "" );
        }
